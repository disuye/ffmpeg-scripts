...
A growing repository of FFMPEG batch scripts to help music, audio & video creators.

# FFMPEG

FFMPEG needs to be pre-installed on your computer for any of these scripts work:
